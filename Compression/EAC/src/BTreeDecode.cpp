...
bool GCALL BTREE_is(void const* compresseddata) {
    bool ok = false;
...
int GCALL BTREE_size(void const* compresseddata) {
    int len = 0;
...
int GCALL BTREE_decode(void* dest, void const* compresseddata, int* compressedsize) {
