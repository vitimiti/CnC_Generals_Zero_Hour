...
bool GCALL REF_is(void const* compresseddata) {
    bool ok       = false;
...
int GCALL REF_size(void const* compresseddata) {
    int len      = 0;
    int packtype = ggetm(compresseddata, 2);
...
int GCALL REF_decode(void* dest, void const* compresseddata, int* compressedsize) {
    unsigned char* s;
    unsigned char* ref;
    unsigned char* d;
    unsigned char  first;
